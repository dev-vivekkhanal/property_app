...
import 'package:porperty_app/pages/root.dart';
...
class _Login2State extends State<Login2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 128, 95, 249),
  ...
  Widget richText(double fontSize) {
    return Text.rich(
      TextSpan(
        style: GoogleFonts.inter(
          fontSize: fontSize,
          color: const Color.fromARGB(255, 128, 95, 249),
        ...
        children: const [
          ...
          TextSpan(
            text: 'PAGE',
            style: TextStyle(
              color: Color.fromARGB(255, 244, 134, 50),
              fontWeight: FontWeight.w800,
            ),
          ),
        ],
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: TextField(
          ...
          cursorColor: const Color.fromARGB(255, 128, 95, 249),
          decoration: InputDecoration(
            hintText: 'Enter your email',
            hintStyle: GoogleFonts.inter(
              fontSize: 16.0,
              color: const Color.fromARGB(255, 128, 95, 249).withOpacity(0.5),
            ),
            filled: true,
            ...
            enabledBorder: OutlineInputBorder(
                ...
                borderSide: BorderSide(
                  color: emailController.text.isEmpty
                      ? Colors.transparent
                      : const Color.fromARGB(255, 128, 95, 249),
                )),
            focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(40),
                borderSide: const BorderSide(
                  color: Color.fromARGB(255, 128, 95, 249),
                )),
            prefixIcon: Icon(
              Icons.mail_outline_rounded,
              color: emailController.text.isEmpty
                  ? const Color.fromARGB(255, 128, 95, 249).withOpacity(0.5)
                  : const Color.fromARGB(255, 128, 95, 249),
              size: 16,
            ),
            suffix: Container(
  ...
  Widget buildRememberForgetSection() {
    ...
    return Padding(
        ...
        child:
            ...
            //         color: Color.fromARGB(255, 128, 95, 249),
            //       ),
            //       child: remember_status == true
            //           ? TextButton(
            //               onPressed: () => {
            //                 print('hello')
            //                 // setState({remember_status = false})
            //               },
            //               child: const Icon(
            //                 Icons.check,
            //                 size: 20,
                  ...
                  child: Theme(
                    data: ThemeData(
                        unselectedWidgetColor: const Color.fromARGB(
                            255, 128, 95, 249) // Your color
                        ),
                    child: Checkbox(
                        activeColor: const Color.fromARGB(255, 128, 95, 249),
                        value: _isChecked,
